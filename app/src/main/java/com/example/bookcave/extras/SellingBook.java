...
public class SellingBook {
    ...
    public SellingBook(String sellerbookid, String bookid, String sellerid, int quantities, int sellingprice, int rentingprice, int deliverycharges, String title, String author, String description, String category, String thumbnail, String preview, Date date) {
