...
//                SellingBook sellingBook=new SellingBook(book_id,uniqueid,userid,uq,up,urp,udp,book_title,book_author,book_desc,book_cat,image,preview,date);
                ...
                book.put("description", book_desc);
                book.put("category", book_cat);
                book.put("thumbnail", image);
                book.put("preview", preview);
                book.put("date", date);
...
//                book.put("deliverycharges", udp);
                ...
                db.collection("SellingList").document(uniqueid).set(book)
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(AddBook.this, "Error ", Toast.LENGTH_LONG).show();
                            }
                        });
            }
        });
